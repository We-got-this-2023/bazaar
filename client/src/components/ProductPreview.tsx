...
export default function ProductPreview({ product }: any) {
  ...
  return (
    <Link to={`/products/${id}`}>
      <div className="m-10 rounded-3xl bg-neutral-200 px-8 py-4 shadow-[3px_3px_10px_1px_#00000060] transition-all duration-200 hover:-translate-y-[2px] hover:-translate-x-[2px] hover:shadow-[4px_4px_12px_2px_#00000060] hover:brightness-105 dark:bg-neutral-800">
